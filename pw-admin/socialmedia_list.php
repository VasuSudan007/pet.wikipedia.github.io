...
frmobj.action = "socialmedia_del.php";
frmobj.submit();
}
else{ 
return false;
...
location.href='socialmedia_del.php?submits=Delete&ids[]='+vla;
}
</script>
...
<a href="dashboard.php">Home / Manage Social Media Link  </a>
</li>
...
<a href="socialmedia_addf.php" class="label label-lg label-primary" ><i class="fa fa-plus " style="margin-right: 5px;" ></i>Add More</a>
</div>
...
<th class="center">Social Media Name</th>
...
$sql=mysql_query_db("select * from tbl_social_media where 1=1 $wh order by $order_by $order_by2 limit $start,$pagesize");
$reccnt=mysql_num_db(mysql_query_db("select * from tbl_social_media where 1=1 $wh"));
if($reccnt>0){
$f=1;
...
<td class="center"><?php echo ucwords(stripslashes($line['smname']));?></td>
<td class="center"><i class="fab fa-<?php echo $line['smname'];?>"></i></td>
<td class="center"><?php echo ucwords(stripslashes($line['smlink']));?></td>
...
<button class="btn btn-xs btn-info" type="button" onClick="location.href='socialmedia_addf.php?id=<?php echo $line['id'];?>&start=<?php echo $start;?>'">
...
<button class="btn btn-success" name="submits" onclick="return del_prompt(this.form,this.value,'socialmedia_list.php')" type="submit" value="Activate">Mark as Active</button>
<button class="btn btn-warning" name="submits" onclick="return del_prompt(this.form,this.value,'socialmedia_list.php')" type="submit" value="Deactivate">Mark as Deactive </button>
<button class="btn btn-danger" name="submits" onclick="return del_prompt(this.form,this.value,'socialmedia_list.php')" type="submit" value="Delete">Delete</button>
</td></tr>
<?php }else{?>
