...
$sql=mysql_query_db("select * from tbl_admission_form where 1=1 $wh order by $order_by $order_by2 limit $start,$pagesize");
...
<button class="btn btn-success" name="submits" onclick="return del_prompt(this.form,this.value,'enquiry_form_list.php')" type="submit" value="Activate">Mark as unfavourit</button>
<button class="btn btn-warning" name="submits" onclick="return del_prompt(this.form,this.value,'enquiry_form_list.php')" type="submit" value="Deactivate">Mark as favourite </button>
