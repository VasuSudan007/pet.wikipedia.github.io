...
$imgae_name=upload_imagen('image',1920,1280,'../upload_images','../upload_images/thumb');
}
if($id=='')
{
mysql_query_db("insert into tbl_slider set title='$title',image='$imgae_name',status=1,post_date=now()");
}
else
{
...
<img src="../upload_images/thumb/<?php echo $line['image'];?>" border="0" style="width:auto; height:150px; border: 1px solid #d3d3d3; ">
<?php }?>
</div>
</div>
