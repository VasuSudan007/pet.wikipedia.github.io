...
if($submitform=='yes')
{
mysql_query_db("update tbl_superadmin set username='$username',email='$email',phone='$phone' where id='".$_SESSION['sess_admin_id']."'");
$_SESSION['sess_msg']="Records Updated Successfully!!";
...
<li class="active">Edit Admin Settings</li>
</ul><!-- /.breadcrumb -->
</div>
...
<div class="panel-heading warning text-center" style="color:#f00;"><strong><?php echo $_SESSION['sess_msg'];$_SESSION['sess_msg']='';?></strong></div>
<?php }?>
...
<div class="col-sm-9">
<input type="text" id="username" value="<?php echo $username;?>" name="username" required placeholder="Enter Username" class="col-xs-10 col-sm-4" /> 
</div>
</div>
<div class="form-group">
<label class="col-sm-3 control-label no-padding-right" for="form-field-1-1"> Email <span class="red">*</span></label>
<div class="col-sm-9">
<input type="email" id="email" value="<?php echo $email;?>" name="email" required placeholder="Enter Email" class="col-xs-10 col-sm-4" /> 
</div>
</div>
<div class="form-group">
<label class="col-sm-3 control-label no-padding-right" for="form-field-1-1"> Phone <span class="red">*</span></label>
<div class="col-sm-9">
<input type="text" id="phone" value="<?php echo $phone;?>" name="phone" required placeholder="Enter Phone" class="col-xs-10 col-sm-4" /> 
</div>
</div>
<div class="">
