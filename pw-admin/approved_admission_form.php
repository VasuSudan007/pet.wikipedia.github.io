...
<li class="active">
Manage Approved Admission Form
</li>
</ul><!-- /.breadcrumb -->
...
<h1>
<i class="fas fa-check"></i> Manage Approved Admission Form 
</h1>
</div>
<div class="row">
<div class="col-xs-12">
...
$sql=mysql_query_db("select * from tbl_admission_form where status=0 $wh order by $order_by $order_by2 limit $start,$pagesize");
$reccnt=mysql_num_db(mysql_query_db("select * from tbl_admission_form where 1=1 $wh"));
if($reccnt>0){
$f=1;
