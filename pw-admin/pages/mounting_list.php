...
frmobj.action = "mounting_del.php";
frmobj.submit();
}
else{ 
return false;
...
location.href='mounting_del.php?submits=Delete&ids[]='+vla;
}
</script>
</head>
<body class="no-skin">
...
<li class="active">Manage Mounting</li>
</ul><!-- /.breadcrumb -->
...
<button class="btn btn-xs btn-info" type="button" onClick="location.href='mounting_addf.php?id=<?php echo $line['id'];?>&start=<?php echo $start;?>'">
...
<li>
<a href="javascript:void(0)" mounting_addf.php?id=<?php echo $line['id'];?>&start=<?php echo $start;?> class="tooltip-success" data-rel="tooltip" title="Edit">
<span class="green">
...
<button class="btn btn-success" name="submits" onclick="return del_prompt(this.form,this.value,'mounting_list.php')" type="submit" value="Activate">Activate</button>
<button class="btn btn-warning" name="submits" onclick="return del_prompt(this.form,this.value,'mounting_list.php')" type="submit" value="Deactivate">Deactivate</button>
<button class="btn btn-danger" name="submits" onclick="return del_prompt(this.form,this.value,'mounting_list.php')" type="submit" value="Delete">Delete</button>
</td></tr>
<?php }else{?>
