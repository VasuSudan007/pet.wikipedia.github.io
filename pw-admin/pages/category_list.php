...
location.href='category_del.php?submits=Delete&ids[]='+vla;
}
</script>
</head>
<body class="no-skin">
...
<th class="center">Category/Subcategory Name</th>
<th class="center">Parent</th>
<!--<th class="center">Thumb Images</th>
<th class="center">Banner Images</th>-->
...
$sql=mysql_query_db("select * from tbl_category where 1=1 $wh order by $order_by $order_by2 limit $start,$pagesize");
$reccnt=mysql_num_db(mysql_query_db("select * from tbl_category where 1=1 $wh"));
if($reccnt>0){
$f=1;
...
<td class="center"><?php echo ucwords(stripslashes($line['category']));?></td>
<?php
$cat=mysql_query_db("select * from tbl_category where id='".$line['parent_id']."'");
$fcat=mysql_fetch_db($cat);
?>
<td class="center"><?php if($fcat['id']){?><?php echo ucwords(stripslashes($fcat['category']));?><?php } else {?><span class="label label-sm label-inverse arrowed-in">Category</span><?php }?></td>
<!--<td class="center"><img src="../upload_images/thumb/<?php //echo $line['image'];?>" class="img-responsive" style="max-width:100px; "></td>
<td class="center"><img src="../upload_images/thumb/<?php //echo $line['image2'];?>" class="img-responsive" style="max-width:100px; "></td>-->
<td class="center">
...
<button class="btn btn-xs btn-info" type="button" onClick="location.href='category_addf.php?id=<?php echo $line['id'];?>&start=<?php echo $start;?>'">
...
<li>
<a href="javascript:void(0)" category_addf.php?id=<?php echo $line['id'];?>&start=<?php echo $start;?> class="tooltip-success" data-rel="tooltip" title="Edit">
<span class="green">
...
<button class="btn btn-success" name="submits" onclick="return del_prompt(this.form,this.value,'category_list.php')" type="submit" value="Activate">Activate</button>
<button class="btn btn-warning" name="submits" onclick="return del_prompt(this.form,this.value,'category_list.php')" type="submit" value="Deactivate">Deactivate</button>
<button class="btn btn-danger" name="submits" onclick="return del_prompt(this.form,this.value,'category_list.php')" type="submit" value="Delete">Delete</button>
</td></tr>
<?php }else{?>
