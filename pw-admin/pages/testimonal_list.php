...
frmobj.action = "testimonal_del.php";
frmobj.submit();
}
else{ 
return false;
...
location.href='testimonal_del.php?submits=Delete&ids[]='+vla;
}
</script>
...
$sql=mysql_query_db("select * from tbl_testimonal where 1=1 $wh order by $order_by $order_by2 limit $start,$pagesize");
$reccnt=mysql_num_db(mysql_query_db("select * from tbl_testimonal where 1=1 $wh"));
if($reccnt>0){
$f=1;
...
<td class="center"><span class="label label-sm label-warning"><?php echo limitthestring($line['description'],100);?></span></td>
<td class="center">
...
<button class="btn btn-xs btn-info" type="button" onClick="location.href='testimonal_addf.php?id=<?php echo $line['id'];?>&start=<?php echo $start;?>'">
...
<button class="btn btn-success" name="submits" onclick="return del_prompt(this.form,this.value,'testimonal_list.php')" type="submit" value="Activate">Activate</button>
<button class="btn btn-warning" name="submits" onclick="return del_prompt(this.form,this.value,'testimonal_list.php')" type="submit" value="Deactivate">Deactivate</button>
<button class="btn btn-danger" name="submits" onclick="return del_prompt(this.form,this.value,'testimonal_list.php')" type="submit" value="Delete">Delete</button>
</td></tr>
<?php }else{?>
