...
$imgae_name=upload_imagen('image',350,465,'../upload_images','../upload_images/thumb');
}
if($id=='')
{
mysql_query_db("insert into tbl_slider set title='$title',link='".addslashes($link)."',image='$imgae_name',status=1,post_date=now()");
}
else
{
$sql="update tbl_slider set title='$title',link='".addslashes($link)."'";
if($imgae_name)
{
...
if($id)
{
$sql=mysql_query_db("select * from tbl_slider where id='$id'");
...
<div class="form-group">
<label class="col-sm-3 control-label no-padding-right" for="form-field-1-1">Text<span class="red">*</span></label>
<div class="col-sm-5">
<textarea name="link" class="form-control"><?php echo stripslashes($link);?></textarea> 
</div>
</div>
<div class="form-group">
