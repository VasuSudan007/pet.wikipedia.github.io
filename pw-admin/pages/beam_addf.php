...
if($id=='')
{
mysql_query_db("insert into tbl_beam_angle set title='".addslashes($title)."',status=1,post_date=now()");
}
else
{
$sql="update tbl_beam_angle set title='".addslashes($title)."'";
$sql.=" where id='$id'";
mysql_query_db($sql);
}
header("location:beam_list.php");
}
if($id)
{
$sql=mysql_query_db("select * from tbl_beam_angle where id='$id'");
...
<li class="active">Add Beam Angel</li>
</ul><!-- /.breadcrumb -->
</div>
