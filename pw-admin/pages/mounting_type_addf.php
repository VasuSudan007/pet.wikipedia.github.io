...
if($id=='')
{
mysql_query_db("insert into tbl_mounting set title='".addslashes($title)."',status=1,post_date=now()");
}
else
{
$sql="update tbl_mounting set title='".addslashes($title)."'";
$sql.=" where id='$id'";
mysql_query_db($sql);
}
header("location:mounting_type_list.php");
}
if($id)
{
$sql=mysql_query_db("select * from tbl_mounting where id='$id'");
...
<li class="active">Add Mounting Type</li>
</ul><!-- /.breadcrumb -->
</div>
