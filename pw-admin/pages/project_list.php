...
location.href='project_del.php?submits=Delete&ids[]='+vla;
}
</script>
...
$sql=mysql_query_db("select * from tbl_project where 1=1 $wh order by $order_by $order_by2 limit $start,$pagesize");
$reccnt=mysql_num_db(mysql_query_db("select * from tbl_project where 1=1 $wh"));
if($reccnt>0){
$f=1;
...
<td class="center"><?php echo limitthestring(ucwords(stripslashes($line['description'])),100);?></td>
<td class="center"><?php echo limitthestring($line['brief'],100);?></td>
<td class="center">
...
<button class="btn btn-xs btn-info" type="button" onClick="location.href='project_addf.php?id=<?php echo $line['id'];?>&start=<?php echo $start;?>'">
...
<button class="btn btn-success" name="submits" onclick="return del_prompt(this.form,this.value,'project_list.php')" type="submit" value="Activate">Activate</button>
<button class="btn btn-warning" name="submits" onclick="return del_prompt(this.form,this.value,'project_list.php')" type="submit" value="Deactivate">Deactivate</button>
<button class="btn btn-danger" name="submits" onclick="return del_prompt(this.form,this.value,'project_list.php')" type="submit" value="Delete">Delete</button>
</td></tr>
<?php }else{?>
