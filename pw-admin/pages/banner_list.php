...
location.href='banner_del.php?submits=Delete&ids[]='+vla;
}
</script>
</head>
<body class="no-skin">
...
$sql=mysql_query_db("select * from tbl_banner where 1=1 $wh order by $order_by $order_by2 limit $start,$pagesize");
$reccnt=mysql_num_db(mysql_query_db("select * from tbl_banner where 1=1 $wh"));
if($reccnt>0){
$f=1;
...
<td class="center" style="text-align:center; "><img src="../upload_images/thumb/<?php echo $line['image'];?>" class="img-responsive" style="max-width:100px; "></td>
...
<button class="btn btn-xs btn-info" type="button" onClick="location.href='banner_addf.php?id=<?php echo $line['id'];?>&start=<?php echo $start;?>'">
...
<li>
<a href="javascript:void(0)" banner_addf.php?id=<?php echo $line['id'];?>&start=<?php echo $start;?> class="tooltip-success" data-rel="tooltip" title="Edit">
<span class="green">
...
<button class="btn btn-success" name="submits" onclick="return del_prompt(this.form,this.value,'banner_list.php')" type="submit" value="Activate">Activate</button>
<button class="btn btn-warning" name="submits" onclick="return del_prompt(this.form,this.value,'banner_list.php')" type="submit" value="Deactivate">Deactivate</button>
<button class="btn btn-danger" name="submits" onclick="return del_prompt(this.form,this.value,'banner_list.php')" type="submit" value="Delete">Delete</button>
</td></tr>
<?php }else{?>
