...
location.href='users_del.php?submits=Delete&ids[]='+vla;
}
</script>
...
<td class="center"><?php echo ucwords(stripslashes($line['username']));?></td>
<td class="center"><?php echo ucwords(stripslashes($line['password']));?></td>
<td class="center"><?php echo ucwords(stripslashes($line['email']));?></td>
<td class="center"><?php echo ucwords(stripslashes($line['sex']));?></td>
<td class="center"><?php echo limitthestring($line['subject'],100);?></td>
<td class="center">
...
<button class="btn btn-xs btn-info" type="button" onClick="location.href='users_addf.php?id=<?php echo $line['id'];?>&start=<?php echo $start;?>'">
...
<button class="btn btn-success" name="submits" onclick="return del_prompt(this.form,this.value,'users_list.php')" type="submit" value="Activate">Activate</button>
<button class="btn btn-warning" name="submits" onclick="return del_prompt(this.form,this.value,'users_list.php')" type="submit" value="Deactivate">Deactivate</button>
<button class="btn btn-danger" name="submits" onclick="return del_prompt(this.form,this.value,'users_list.php')" type="submit" value="Delete">Delete</button>
</td></tr>
<?php }else{?>
