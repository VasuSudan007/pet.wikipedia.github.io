...
$imgae_name=upload_imagen('image',370,240,'../upload_images','../upload_images/thumb');
}
if($id=='')
{
mysql_query_db("insert into tbl_testimonal set title='$title',description='$editor1',image='$imgae_name',status=1,post_date=now()");
}
else
{
$sql="update tbl_testimonal set title='$title',description='$editor1'";
if($imgae_name)
{
...
header("location:testimonal_list.php");
}
if($id)
{
$sql=mysql_query_db("select * from tbl_testimonal where id='$id'");
