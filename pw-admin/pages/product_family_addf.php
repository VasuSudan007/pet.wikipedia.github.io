...
if($id=='')
{
mysql_query_db("insert into tbl_product_family set title='".addslashes($title)."',status=1,post_date=now()");
}
else
{
$sql="update tbl_product_family set title='".addslashes($title)."'";
$sql.=" where id='$id'";
mysql_query_db($sql);
}
header("location:product_family_list.php");
}
if($id)
{
$sql=mysql_query_db("select * from tbl_product_family where id='$id'");
...
<li class="active">Add Product Family</li>
</ul><!-- /.breadcrumb -->
</div>
