...
frmobj.action = "producttype_del.php";
frmobj.submit();
}
else{ 
return false;
...
location.href='producttype_del.php?submits=Delete&ids[]='+vla;
}
</script>
</head>
<body class="no-skin">
...
$sql=mysql_query_db("select * from tbl_producttype where 1=1 $wh order by $order_by $order_by2 limit $start,$pagesize");
$reccnt=mysql_num_db(mysql_query_db("select * from tbl_producttype where 1=1 $wh"));
if($reccnt>0){
$f=1;
...
<button class="btn btn-xs btn-info" type="button" onClick="location.href='producttype_addf.php?id=<?php echo $line['id'];?>&start=<?php echo $start;?>'">
...
<li>
<a href="javascript:void(0)" producttype_addf.php?id=<?php echo $line['id'];?>&start=<?php echo $start;?> class="tooltip-success" data-rel="tooltip" title="Edit">
<span class="green">
...
<button class="btn btn-success" name="submits" onclick="return del_prompt(this.form,this.value,'producttype_list.php')" type="submit" value="Activate">Activate</button>
<button class="btn btn-warning" name="submits" onclick="return del_prompt(this.form,this.value,'producttype_list.php')" type="submit" value="Deactivate">Deactivate</button>
<button class="btn btn-danger" name="submits" onclick="return del_prompt(this.form,this.value,'producttype_list.php')" type="submit" value="Delete">Delete</button>
</td></tr>
<?php }else{?>
