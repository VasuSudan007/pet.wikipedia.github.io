...
location.href='fees_del.php?submits=Delete&ids[]='+vla;
}
</script>
...
$sql=mysql_query_db("select * from tbl_fees where status=0 order by $order_by $order_by2 limit $start,$pagesize");
$reccnt=mysql_num_db(mysql_query_db("select * from tbl_fees where status=0"));
if($reccnt>0){
$f=1;
...
<td class="center"><?php echo ucwords(stripslashes($line['name']));?></td>
<td class="center"><?php echo ucwords(stripslashes($line['sclass']));?>-<?php echo ucwords(stripslashes($line['ssection']));?></td>
...
<?php }else{?>
<span class="label label-lg label-success"><i class="fas fa-check-circle"> Paid</i> </span>
<?php }?>
...
<button class="btn btn-xs btn-info" type="button" onClick="location.href='fees_addf.php?id=<?php echo $line['id'];?>&start=<?php echo $start;?>'">
...
<button class="btn btn-success" name="submits" onclick="return del_prompt(this.form,this.value,'fees_list.php')" type="submit" value="Activate">Mark as unfavourit</button>
<button class="btn btn-warning" name="submits" onclick="return del_prompt(this.form,this.value,'fees_list.php')" type="submit" value="Deactivate">Mark as favourite </button>
<button class="btn btn-danger" name="submits" onclick="return del_prompt(this.form,this.value,'fees_list.php')" type="submit" value="Delete">Delete</button>
</td></tr>
<?php }else{?>
