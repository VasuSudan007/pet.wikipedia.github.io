...
$sql=mysql_query_db("select * from tbl_fees where 1=1 $wh order by $order_by $order_by2 limit $start,$pagesize");
$reccnt=mysql_num_db(mysql_query_db("select * from tbl_fees where 1=1 $wh"));
if($reccnt>0){
$f=1;
