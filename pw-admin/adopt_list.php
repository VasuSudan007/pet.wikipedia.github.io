...
location.href='adopt_del.php?submits=Delete&ids[]='+vla;
}
</script>
...
<th class="center">Pet Age</th>
<th class="center">Pet Category</th>
<th class="center">Pet Breed</th>
<th class="center">Pet Image</th>
...
$sql=mysql_query_db("select * from tbl_adopt where 1=1 $wh order by $order_by $order_by2 limit $start,$pagesize");
$reccnt=mysql_num_db(mysql_query_db("select * from tbl_adopt where 1=1 $wh"));
if($reccnt>0){
$f=1;
...
<td class="center"><?php echo $line['pet_name'];?></td>
<td class="center"><?php echo ucwords(stripslashes($line['pet_age']));?></td>
<td class="center"><?php echo stripslashes($line['pet_category']);?></td>
<td class="center"><?php echo stripslashes($line['pet_breed']);?></td>
<td class="center"><img src="../upload_images/thumb/<?php echo $line['image'];?>" class="center" style="max-height:100px; "></td>
...
<button class="btn btn-xs btn-info" type="button" onClick="location.href='adopt_addf.php?id=<?php echo $line['id'];?>&start=<?php echo $start;?>'">
...
<button class="btn btn-success" name="submits" onclick="return del_prompt(this.form,this.value,'adopt_list.php')" type="submit" value="Activate">Activate</button>
<button class="btn btn-warning" name="submits" onclick="return del_prompt(this.form,this.value,'adopt_list.php')" type="submit" value="Deactivate">Deactivate</button>
<button class="btn btn-danger" name="submits" onclick="return del_prompt(this.form,this.value,'adopt_list.php')" type="submit" value="Delete">Delete</button>
</td></tr>
<?php }else{?>
