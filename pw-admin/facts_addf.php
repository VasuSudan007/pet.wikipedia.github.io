...
$imgae_name=upload_imagen('image',370,407,'../upload_images','../upload_images/thumb');
}
if($id=='')
{
mysql_query_db("insert into tbl_facts set title='$title', description='$description',image='$imgae_name',status=1,post_date=now()");
}
else
{
$sql="update tbl_facts set title='$title' , description='$description'";
if($imgae_name)
{
...
if($id)
{
$sql=mysql_query_db("select * from tbl_facts where id='$id'");
...
<label class="col-sm-3 control-label no-padding-right" for="form-field-1-1">Facts<span class="red">*</span></label>
<div class="col-sm-9">
...
<div class="col-sm-9">
<input type="text" id="description" value="<?php echo $description;?>" name="description" title="please enter description" placeholder="Enter description" class="col-xs-10 col-sm-4" /> 
</div>
</div>
<!--<div class="form-group">
