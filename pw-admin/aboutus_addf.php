...
if($id=='')
{
mysql_query_db("insert into tbl_aboutus set title='".addslashes($title)."',para1='".addslashes($para1)."',para2='".addslashes($para2)."',post_date=now() ,status=1");
}
else
{
$sql="update tbl_aboutus set title='".addslashes($title)."',para1='".addslashes($para1)."',para2='".addslashes($para2)."'";
$sql.=" where id='$id'";
mysql_query_db($sql);
}
header("location:aboutus_list.php");
}
if($id)
{
$sql=mysql_query_db("select * from tbl_aboutus where id='$id'");
...
<input type="text" id="title" value="<?php echo $title;?>" name="title" title="please enter title" placeholder="Enter title" class="col-xs-10 col-sm-4" /> 
	...
	<div class="form-group">
<label class="col-sm-3 control-label no-padding-right" for="form-field-1-1">Paragraph 1<span class="red">*</span></label>
<div class="col-sm-9">
<textarea name="para1" class="form-control"><?php echo stripslashes($para1);?></textarea> 
</div></div>
<div class="form-group">
<label class="col-sm-3 control-label no-padding-right" for="form-field-1-1">Paragraph 2<span class="red">*</span></label>
<div class="col-sm-9">
<textarea name="para2" class="form-control"><?php echo stripslashes($para2);?></textarea> 
</div>
</div>
<div >
