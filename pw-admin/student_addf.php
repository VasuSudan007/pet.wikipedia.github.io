...
if($id=='')
{
mysql_query_db("insert into tbl_student set title='$title',image='$imgae_name',name='$name',description='".addslashes($description)."',status=1,post_date=now()");
}
else
{
$sql="update tbl_student set title='$title',description='".addslashes($description)."',	name='$name'";
if($imgae_name)
{
...
if($id)
{
$sql=mysql_query_db("select * from tbl_student where id='$id'");
...
<h1>
Edit Top 3 Students of this Month
</h1>
</div>
<div class="row">
<div class="col-xs-12">
...
<label class="col-sm-3 control-label no-padding-right" for="form-field-1-1">Student Name<span class="red">*</span></label>
<div class="col-sm-9">
...
<div class="form-group">
<label class="col-sm-3 control-label no-padding-right" for="form-field-1-1">Designation <span class="red">*</span><p style="font-size: 12px;">(Head Boy, Student, Prefect, etc)</p></label>
<div class="col-sm-9">
