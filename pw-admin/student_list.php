...
location.href='student_del.php?submits=Delete&ids[]='+vla;
}
</script>
...
<h1>
Manage Top 3 Students of this Month
</h1>
</div>
<div class="row">
<div class="col-xs-12">
...
<th class="center">Student Profile</th>
...
$sql=mysql_query_db("select * from tbl_student where 1=1 $wh order by $order_by $order_by2 limit $start,$pagesize");
$reccnt=mysql_num_db(mysql_query_db("select * from tbl_student where 1=1 $wh"));
if($reccnt>0){
$f=1;
...
<td class="center"><?php echo $line['name'];?></td>
<td class="center"><?php echo ucwords(stripslashes($line['title']));?></td>

<td class="center"><img src="../upload_images/thumb/<?php echo $line['image'];?>" class="center" style="max-width:100px; "></td>
...
<button class="btn btn-xs btn-info" type="button" onClick="location.href='student_addf.php?id=<?php echo $line['id'];?>&start=<?php echo $start;?>'">
...
<button class="btn btn-success" name="submits" onclick="return del_prompt(this.form,this.value,'student_list.php')" type="submit" value="Activate">Activate</button>
<button class="btn btn-warning" name="submits" onclick="return del_prompt(this.form,this.value,'student_list.php')" type="submit" value="Deactivate">Deactivate</button>
<button class="btn btn-danger" name="submits" onclick="return del_prompt(this.form,this.value,'student_list.php')" type="submit" value="Delete">Delete</button>
</td></tr>
<?php }else{?>
