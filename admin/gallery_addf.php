...
if($id=='')
{
mysql_query_db("insert into tbl_gallery set title='$title',image='$imgae_name',status=1,post_date=now()");
}
else
{
$sql="update tbl_gallery set title='$title'";
if($imgae_name)
{
...
if($id)
{
$sql=mysql_query_db("select * from tbl_gallery where id='$id'");
...
<label class="col-sm-3 control-label no-padding-right" for="form-field-1-1">Image Name<span class="red">*</span></label>
<div class="col-sm-9">
