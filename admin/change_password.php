...
{
mysql_query_db("update tbl_admin set password='$npassword',modify_date=now() where id='".$_SESSION['sess_admin_id']."'");
        ...
        <div class="content-wrapper">
          ...
          <div class="row">
            <div class="col-12 grid-margin">
              <div class="card">
                <div class="card-body">
                  <h5 class="card-title" style="color: #7A828B">Dashboard / Change Password</h5>
                  <h3 style="color:#459CFD"><b>Change Password</b></h3>
...
<div class="panel-heading warning"><strong style="color:#A74242"><?php echo $_SESSION['sess_msg'];$_SESSION['sess_msg']='';?></strong></div>
<?php }?>
                    ...
                    <div>
                      ...
                      <section>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-9">       
                            <input type="password" id="password" name="password" required placeholder="Enter Password" class="col-xs-10 col-sm-4 required form-control" /> </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-9">
                              <input type="password" id="npassword" name="npassword" required placeholder="Enter New Password" class="col-xs-10 col-sm-4 required form-control" /> 
                            </div>
                          </div>
                          <div class="form-group">
                            <label for="confirm">Confirm Password *</label>
                            <div class="col-sm-9">
                              <input type="password" id="rpassword" name="rpassword"  required placeholder="Enter Password" class="col-xs-10 col-sm-4 required form-control" /> 
                            </div>
